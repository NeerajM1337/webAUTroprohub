    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">APH VIEW COMPLAINTS</h5>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>101</td>
                    <td>mAnto</td>
                    <td>anto332@gmail.com</td>
                    <td>9906576547</td>
                    <td>Rentalservices</td>
                    <td>i have a complaint that </td>

                    <td>21/02/2023</td>


                      <td>
                        <button type="button" class="btn btn-primary" onclick="navigateToPage('aph_send_reply.html')">Reply</button>
                      </td>
