    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Send Reply Form</h5>
              ...
              <form class="row g-3">
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingComplaintID" placeholder="Complaint ID">
                    <label for="floatingComplaintID">Complaint ID</label>
                  </div>
                </div>
          
                <!-- Complaint Name input -->
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingComplaintName" placeholder="Complaint Name">
                    <label for="floatingComplaintName">Complaint Name</label>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <textarea class="form-control" placeholder="Reply" id="floatingReply" style="height: 100px;"></textarea>
                    <label for="floatingReply">Reply</label>
                  </div>
                </div>
